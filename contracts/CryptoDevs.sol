...
contract CryptoDevs is ERC721Enumerable, Ownable {
  ...
  */
  ...
  function presaleMint() public payable onlyWhenNotPaused {
    ...
    // if the address being minted to is a contract, then it knows how to deal with
    // ERC721 tokens. If the address being minted to is not a contract, it works
    // the same was as _mint
  ...
  // Fallback functtion is called when msg.data is not empty
